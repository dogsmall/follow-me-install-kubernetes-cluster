...
+ 如果后续使用 kube-apiserver 或者 kubectl proxy 访问 grafana dashboard，则必须将 `GF_SERVER_ROOT_URL` 设置为 `/api/v1/proxy/namespaces/kube-system/services/monitoring-grafana/`，否则后续访问grafana时访问时提示找不到`http://10.8.0.50:8086/api/v1/proxy/namespaces/kube-system/services/monitoring-grafana/api/dashboards/home` 页面；
...
1. 通过 kube-apiserver 访问：
    ...
    浏览器访问 URL： `http://10.8.0.50:8080/api/v1/proxy/namespaces/kube-system/services/monitoring-grafana`
...
1. 通过 kubectl proxy 访问：
    ...
    浏览器访问 URL：`http://10.8.0.50:8086/api/v1/proxy/namespaces/kube-system/services/monitoring-grafana`
...
`http://10.8.0.50:8080/api/v1/proxy/namespaces/kube-system/services/monitoring-influxdb:8083/`
